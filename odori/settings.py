...
GENERATED_RECIPES_ENABLED = (
    os.environ.get("GENERATED_RECIPES_ENABLED", "false").lower() == "true"
)
AZURE_OPENAI_RECIPE_DEPLOYMENT = os.environ.get("AZURE_OPENAI_RECIPE_DEPLOYMENT", "")
AZURE_OPENAI_RECIPE_API_VERSION = os.environ.get(
    "AZURE_OPENAI_RECIPE_API_VERSION", "2024-10-21"
)
AZURE_OPENAI_RECIPE_TIMEOUT_SECONDS = float(
    os.environ.get("AZURE_OPENAI_RECIPE_TIMEOUT_SECONDS", "30")
)
GENERATED_RECIPES_DAILY_JOB_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_DAILY_JOB_LIMIT", "10")
)
GENERATED_RECIPES_MONTHLY_JOB_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_MONTHLY_JOB_LIMIT", "100")
)
GENERATED_RECIPES_MAX_INPUT_TOKENS = int(
    os.environ.get("GENERATED_RECIPES_MAX_INPUT_TOKENS", "2000")
)
GENERATED_RECIPES_MAX_OUTPUT_TOKENS = int(
    os.environ.get("GENERATED_RECIPES_MAX_OUTPUT_TOKENS", "1200")
)
GENERATED_RECIPES_DAILY_INPUT_TOKEN_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_DAILY_INPUT_TOKEN_LIMIT", "20000")
)
GENERATED_RECIPES_DAILY_OUTPUT_TOKEN_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_DAILY_OUTPUT_TOKEN_LIMIT", "12000")
)
GENERATED_RECIPES_MONTHLY_INPUT_TOKEN_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_MONTHLY_INPUT_TOKEN_LIMIT", "200000")
)
GENERATED_RECIPES_MONTHLY_OUTPUT_TOKEN_LIMIT = int(
    os.environ.get("GENERATED_RECIPES_MONTHLY_OUTPUT_TOKEN_LIMIT", "120000")
)
GENERATED_RECIPES_MIN_INTERVAL_SECONDS = float(
    os.environ.get("GENERATED_RECIPES_MIN_INTERVAL_SECONDS", "10")
)
GENERATED_RECIPES_MAX_ATTEMPTS = int(
    os.environ.get("GENERATED_RECIPES_MAX_ATTEMPTS", "3")
)
