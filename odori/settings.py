...
INGREDIENT_MAPPING_REVIEW_MIN_SCORE = float(
    os.environ.get("INGREDIENT_MAPPING_REVIEW_MIN_SCORE", "0.35")
)
INGREDIENT_AUTO_MATCH_MIN_MARGIN = float(
    os.environ.get("INGREDIENT_AUTO_MATCH_MIN_MARGIN", "0.08")
)
INGREDIENT_MAPPING_POLICY_VERSION = os.environ.get("INGREDIENT_MAPPING_POLICY_VERSION", "v1")
...
AZURE_OPENAI_RECIPE_IMPORT_MAX_OUTPUT_TOKENS = int(
    os.environ.get("AZURE_OPENAI_RECIPE_IMPORT_MAX_OUTPUT_TOKENS", "4000")
)
